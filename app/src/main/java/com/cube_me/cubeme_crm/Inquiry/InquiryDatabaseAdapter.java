...
public class InquiryDatabaseAdapter {
    ...
    public long saveInquiry(Inquiry inquiry) {
        ...
        inquiryCV.put(databaseHelper.CONTACT_NUMBER, inquiry.inquiryCompanyPhoneNumber);
        inquiryCV.put(databaseHelper.EMAIL_ID, inquiry.inquiryCompanyEmailID);
        inquiryCV.put(databaseHelper.ASSIGN_TO, inquiry.salesPerson);
    ...
    public List<Inquiry> getAllInquiries(){
        ...
        while (cursor.moveToNext()){
            ...
            inquiry.setInquiryCompanyPhoneNumber(cursor.getString(contactNoInd));
            inquiry.setInquiryCompanyEmailID(cursor.getString(emailIDInd));
            inquiry.setSalesPerson(cursor.getString(assignTOInd));
    ...
    public class InquiryDatabaseHelper extends SQLiteOpenHelper {
        ...
        private final static String PROJECT_TYPE = "MasterProjectType";
