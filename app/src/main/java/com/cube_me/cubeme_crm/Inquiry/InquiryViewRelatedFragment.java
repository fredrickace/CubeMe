...
import com.cube_me.cubeme_crm.Estimation.EstimationDatabaseAdapter;
import com.cube_me.cubeme_crm.Estimation.EstimationListRecyclerAdapter;
import com.cube_me.cubeme_crm.Estimation.EstimationPreview;
...
//        inquiryObj = bundle.getParcelable("ViewInquiry");
//        inquiryID = inquiryObj.inquiryID;
//        estimationId = "EST/"+ inquiryID.substring(4);
//        Log.i("EstimationID",estimationId);
