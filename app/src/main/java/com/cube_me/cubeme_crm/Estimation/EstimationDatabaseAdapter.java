...
//        cursor.moveToFirst();
    ...
    public long insertJobTable(List<EstimationJobs> jobData, String estimationID) {
        ...
        for (int i = 0; i < jobData.size(); i++) {
            ...
            jobContentValues.put(databaseHelper.JOB_DESCRIPTION, estimationJobs.jobDescription);
    ...
    public List<EstimationJobs> getJobData(String estimationID) {
        ...
        String[] jobColumns = {databaseHelper.JOB_NAME, databaseHelper.JOB_UNIT, databaseHelper.JOB_DESCRIPTION,
        ...
        while (jobCursor.moveToNext()) {
            ...
            int jobDescIndId = jobCursor.getColumnIndex(databaseHelper.JOB_DESCRIPTION);
            ...
            estimationJobs.setJobDescription(jobCursor.getString(jobDescIndId));
    ...
    public long insertMPTable(List<EstimationOtherMaterials> data, String estimationID) {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            mpContentValues.put(databaseHelper.MP_UNITS, EOM.otherMaterialNoOfUnits);
            mpContentValues.put(databaseHelper.MP_RESOURCES, EOM.otherMaterialNoOfResources);
    ...
    public List<EstimationOtherMaterials> getMPTable(String estID) {
        ...
        while (mpCursor.moveToNext()) {
            ...
            MP.setOtherMaterialNoOfUnits(mpCursor.getFloat(mpDayIndex));
            MP.setOtherMaterialNoOfResources(mpCursor.getFloat(mpHoursIndex));
    ...
    public long insertToolsTable(List<EstimationOtherMaterials> data, String estimationID) {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            toolsContentValues.put(databaseHelper.TOOLS_UNIT, toolsEOM.otherMaterialNoOfUnits);
            toolsContentValues.put(databaseHelper.TOOLS_RESOURCES, toolsEOM.otherMaterialNoOfResources);
    ...
    public List<EstimationOtherMaterials> getToolsTable(String estID) {
        ...
        while (toolsCursor.moveToNext()) {
            ...
            toolsEOM.setOtherMaterialNoOfUnits(toolsCursor.getFloat(toolsDayIndex));
            toolsEOM.setOtherMaterialNoOfResources(toolsCursor.getFloat(toolsHoursIndex));
    ...
    public long insertTransportTable(List<EstimationOtherMaterials> data, String estimationID) {
        ...
        for (int i = 0; i < data.size(); i++) {
            ...
            transportConttentValues.put(databaseHelper.TRANSPORT_UNIT, transportEOM.otherMaterialNoOfUnits);
            transportConttentValues.put(databaseHelper.TRANSPORT_RESOURCES, transportEOM.otherMaterialNoOfResources);
    ...
    public List<EstimationOtherMaterials> getTransportTable(String estID) {
        ...
        while (transportCursor.moveToNext()) {
            ...
            transportEOM.setOtherMaterialNoOfUnits(transportCursor.getFloat(transportDayIndex));
            transportEOM.setOtherMaterialNoOfResources(transportCursor.getFloat(transportHoursIndex));
    ...
    class EstimationDatabaseHelper extends SQLiteOpenHelper {
        ...
        private final static String JOB_DESCRIPTION = "JobDescription";
        ...
        private final static String CREATE_JOB_TABLE = "CREATE TABLE " + JOB_TABLE_NAME + " (" + UID + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + ESTIMATION_ID + " VARCHAR(255), " + JOB_NAME + " TEXT, " + JOB_DESCRIPTION +" TEXT, "+ JOB_UNIT + " TEXT, " + JOB_QUANTITY + " REAL, " + JOB_TOTAL + " REAL);";
