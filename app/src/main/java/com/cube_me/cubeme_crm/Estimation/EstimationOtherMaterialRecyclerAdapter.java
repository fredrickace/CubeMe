...
public class EstimationOtherMaterialRecyclerAdapter extends RecyclerView.Adapter<EstimationOtherMaterialRecyclerAdapter.OtherViewHolder> {
    ...
    public void onBindViewHolder(OtherViewHolder holder, int position) {
        ...
        holder.OMUnitTV.setText(BaseActivity.decimalFormat.format(estimationOtherMaterials.otherMaterialNoOfUnits));
        holder.OMNoOfResTV.setText(BaseActivity.decimalFormat.format(estimationOtherMaterials.otherMaterialNoOfResources));
