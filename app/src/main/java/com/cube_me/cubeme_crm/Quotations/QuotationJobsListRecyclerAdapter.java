 ...
 */
public class QuotationJobsListRecyclerAdapter extends RecyclerView.Adapter<QuotationJobsListRecyclerAdapter.QuotationNewViewHolder> {

    List<EstimationJobs> data;
    Context context;
    LayoutInflater inflater;

    public QuotationJobsListRecyclerAdapter(List<EstimationJobs> data, Context context) {
        this.data = data;
