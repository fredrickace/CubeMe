...
public class Quotation implements Parcelable {
    ...
    public void setQuotationGrossTotal(float quotationGrossTotal) {
        this.quotationGrossTotal = quotationGrossTotal;
    }
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeFloat(this.quotationGrossTotal);
    ...
    protected Quotation(Parcel in) {
        ...
        this.quotationGrossTotal = in.readFloat();
