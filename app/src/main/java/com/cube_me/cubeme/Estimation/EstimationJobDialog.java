    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        jobAddButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(BaseActivity.ifEditTextNotEmptyErrMsg(jobNameEditText) && BaseActivity.ifEditTextNotEmptyErrMsg(jobQuantityEditText) && BaseActivity.ifEditTextNotEmptyErrMsg(jobUnitEditText)){
                    communicator.setNewJob(jobNameEditText.getText().toString(),jobUnitEditText.getText().toString(),jobQuantityEditText.getText().toString());
                    dismiss();
                }
            }
        });
