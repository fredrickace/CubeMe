 ...
 */
public class EstimationFragmentRecyclerAdapter extends RecyclerView.Adapter<EstimationFragmentRecyclerAdapter.EstimationFragmentViewHolder> {

    List<Estimation> data;
    Context context;
    LayoutInflater inflater;

    public EstimationFragmentRecyclerAdapter(List<Estimation> data, Context context) {
        this.data = data;
